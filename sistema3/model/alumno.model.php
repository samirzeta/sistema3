...
class AlumnoModel 
{
 ...
 private $bd;
    ...
    public function Actualizar(Alumno $alumno)
    {
        ...
        $this->bd = new Conexion();
        $stmt = $this->bd->prepare("UPDATE alumno SET  primer_nombre=:primer_nombre,apellido_paterno=:apellido_paterno,apellido_materno=:apellido_materno,fecha_nacimiento=:fecha_nacimiento,curso=:curso,carrera=:carrera,activo=:activo,modificado_por=:modificado_por WHERE idAlumno=:idAlumno;");
    ...
    public function Registrar(Alumno $alumno)
    {
        ...
        $this->bd = new Conexion();
        $stmt = $this->bd->prepare("INSERT INTO alumno(primer_nombre,apellido_paterno,apellido_materno,dni,edad,carrera,fecha_nacimiento,curso,ingresado_por) VALUES(:primer_nombre,:apellido_paterno,:apellido_materno,:dni,:edad,:carrera,:fecha_nacimiento,:curso,:ingresado_por)");
